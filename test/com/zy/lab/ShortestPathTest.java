...
public class ShortestPathTest {
    ...
    void testShortestPath_BothWordsExist() {
        ...
        assertEquals("The shortest path(s) from explore to new with length 2 are: explore -> strange -> new\n", result);
    }
    ...
    void testShortestPath_SameWord(){
        ...
        System.out.println(result);
        assertEquals("The shortest path(s) from new to new with length 0 are: new\n", result);
    }
    @Test
        // 测试用例6: 边界值 - 词1与词2无连接
    ...
    void testShortestPath_MultiPaths(){
        ...
        System.out.println(result);
        assertEquals("The shortest path(s) from new to and with length 2 are: new -> life -> and\n", result);
    }
}
